cbApp.factory('UserResource', ['$resource', function ($resource) {
    "use strict";
    return $resource('user');
}]);

cbApp.factory('ProjectResource', ['$resource', function ($resource) {
    "use strict";
    return $resource('project');
}]);

cbApp.factory('CbAuthService', ['$rootScope', '$http', 'authService', function ($rootScope, $http, authService) {
    "use strict";
    return {
        /**
