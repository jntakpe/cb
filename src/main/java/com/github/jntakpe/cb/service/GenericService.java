package com.github.jntakpe.cb.service;

import com.github.jntakpe.cb.domain.GenericDomain;
import com.github.jntakpe.cb.repository.GenericRepository;
...
public abstract class GenericService<T extends GenericDomain<S>, S extends Number> {
    ...
    /**
     * Constructeur. Initialise le champ {@link com.github.jntakpe.cb.service.GenericService#entityClass} contenant l'entité utilisée.
     */
